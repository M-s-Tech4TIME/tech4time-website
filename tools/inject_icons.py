...
def pages() -> list[Path]:
    ...
    # The home page is index.php and the error page is 404.php, both at the
    # root rather than under pages/. Named rather than globbed as "*.php":
    # contact-handler.php and sitemap.php are endpoints, not pages.
    found += sorted(ROOT.glob("index.php"))
    found += sorted(ROOT.glob("404.php"))
