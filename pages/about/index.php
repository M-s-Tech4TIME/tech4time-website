...
<main class="page__main" id="main">
  ...
  <section class="page-hero">
    ...
    <div class="hero-circuit" aria-hidden="true">
      <svg class="hero-circuit__layer hero-circuit__layer--band-top" viewBox="0 0 1440 114" preserveAspectRatio="none" focusable="false">
        <defs>
      ...
      <svg class="hero-circuit__layer hero-circuit__layer--band-bottom" viewBox="0 0 1440 114" preserveAspectRatio="none" focusable="false">
        <g class="hero-circuit__wires"><use href="#hc-band-wires"/></g>
        <g class="hero-circuit__pads"><use href="#hc-band-pads"/></g>
        <g class="hero-circuit__rings"><use href="#hc-band-rings"/></g>
        <g class="hero-circuit__charges">
...
<script src="/assets/js/circuit.js?v=4" defer></script>
