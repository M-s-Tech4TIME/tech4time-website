...
`https://admin.tech4time.bd/?s=chrome` — **a screen that is not built yet**, so until it is, the
document is what the site shipped with. Never hand-edit one in a page file — there is nothing there
